...
### v4
There will be a lot to write, here!
...
#### v3.0
The physical equations and parameter values of this version are the same as in v2.4. A few notable changes are worth mentioning here.
...
#### v2.3
* Added: permafrost carbon thaw and release, exactly as described by [Gasser et al. (2018)](https://doi.org/10.1038/s41561-018-0227-0). This comes with a new CO<sub>2</sub> atmospheric flux accounting for the oxidation of geologic CH<sub>4</sub> released in the atmosphere.
...
#### v2.2
Initial release on GitHub. Exact model desrcibed by [Gasser et al. (2017)](https://doi.org/10.5194/esd-8-235-2017).

#### v2.1
Version described by [Gasser (2014)](https://hal.science/tel-01135456).

#### v2.0
Unpublished version, similar to v2.1 but without non-CO2 species.

### v2
This was a complete rewriting of the original model, translated from Scilab to Python.

#### v1.1
Version with added climate feedback on terrestrial carbon, described by [Gitz (2004)](https://hal.science/pastel-00000622).

#### v1.0
Version described by [Gitz and Ciais (2003)](https://doi.org/10.1029/2002GB001963).

### v1
Original model in Scilab.
